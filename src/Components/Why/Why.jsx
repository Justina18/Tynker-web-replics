    ...
    <div className='Why'>
      <div className='Why-wrap'>
        <div className='Why-Text'>
            <h1 className='why-head-text'>Why Should Kids and Teens Learn to Code with <br/> Tynker?</h1>
            <p> Because <b>technology is so integrated</b> into virtually every aspect of our lives, learning about it is <b>more</b> <br/> <b> important than ever</b>. Our coding platform makes it convenient and fun for kids and teens to gain <br/> knowledge that will serve them well throughout their lives. You can count on our <b>trusted methods</b> to <br/> help them develop and grow their capabilities with computers.<br/>
            <br></br>
        ...
        <div className='Why-Cards'>
          ...
          <div className='Why1'>
            ...
            <p className='p'> Celebrating Women in STEM</p>
          </div>
        ...
        <div className='Trust'>
          ...
          <p className='Trust-text'>Our methods for learning to code all are provided within a safe, moderated community that is built <br/> around encouraging students to gain confidence in their abilities and do so without fear of failure.</p>
          <div >
